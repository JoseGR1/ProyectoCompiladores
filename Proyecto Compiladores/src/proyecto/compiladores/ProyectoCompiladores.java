...
public class ProyectoCompiladores {
 public static void main(String[] args) {
        try {
            ...
            String codigoFrontend = generarCodigoFrontend(encabezado, titulo);
            System.out.println("Código para el frontend generado:\n" + codigoFrontend);
            
            guardarCodigoHTML(codigoFrontend);
    ...
    public static String generarCodigoFrontend(Element encabezado, String titulo) {
    ...
    public static void guardarCodigoHTML(String codigoHTML) {
        try {
